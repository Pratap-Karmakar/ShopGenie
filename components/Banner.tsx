...
function SampleNextArrow(props: any) {
  ...
  return (
    <div
      className="absolute bottom-12 right-6 w-12 h-8 border-[1px] shadow-md border-black text-black bg-white text-xl flex items-center justify-center rounded-md hover:bg-[#C88EA7] hover:scale-95 cursor-pointer duration-300 z-10"
      onClick={onClick}
    >
      <GrLinkNext />
    </div>
...
function SamplePrevArrow(props: any) {
  ...
  return (
    <div
      className="absolute bottom-12 left-6 w-12 h-8 border-[1px] shadow-md border-black text-black bg-white text-xl flex items-center justify-center rounded-md hover:bg-[#C88EA7] hover:scale-95 cursor-pointer duration-300 z-10"
      onClick={onClick}
    >
      <GrLinkPrevious />
    </div>
...
const Banner = () => {
  ...
  return (
    <div className="w-full px-4 py-6 font-titleFont flex gap-4 border-b-[1px]">
